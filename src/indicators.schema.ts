...
import { EFormattingPresets, EFormatTypes, EMeasureInnerTemplateNames, type TSchemaType } from ".";
...
export const WidgetDimensionInHierarchySchema = SchemaRegistry.define({
  ...
  latestVersion: "17",
  history: {
    "17": (z) => WidgetDimensionSchema.forVersion("17")(z).omit({ displayCondition: true }),
  },
});
