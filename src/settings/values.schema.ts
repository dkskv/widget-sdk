import { EDisplayConditionMode } from "..";
...
export const KeyNullableSchema = SchemaRegistry.define({
  ...
  latestVersion: "17",
  history: {
    "17": (z) => z.string().nullable().default(null),
  },
});
...
export const FormulaSchema = SchemaRegistry.define({
  ...
  latestVersion: "17",
  history: {
    "17": (z) => z.string().default("").meta(formulaMeta),
  },
});
...
export const FormulaNullableSchema = SchemaRegistry.define({
  ...
  latestVersion: "17",
  history: {
    "17": (z) => z.string().nullable().default(null).meta(formulaMeta),
  },
});
